...
public class Main {
    ...
    public static void main(String[] args){
        ...
        printStats(algorithm.getClass().getSimpleName(), result, tspFile.getBest(), getError(result, tspFile.getBest()));
        ...
        printStats(optimization.getClass().getSimpleName(), result, tspFile.getBest(), getError(result, tspFile.getBest()));
    ...
    private static void printStats(String algorithmName, int result, int best, double error) {
        System.out.println(algorithmName+" produced result: "+result);
        System.out.println("Best known: "+best);
        System.out.println("Error in percentage: "+error+"%");
    }
